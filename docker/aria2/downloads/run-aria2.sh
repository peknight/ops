...
docker run -d --name pek-aria2 -h pek-aria2 -v $conf_dir:/home/$(id -nu)/.aria2 -v $target_dir:/data -p 6800:6800 -p 9100:9100 -p 42980:42980 -p 42980:42980/udp pek/webui-aria2
